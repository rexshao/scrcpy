...
public final class Streamer {
    ...
    public Streamer(FileDescriptor fd, Codec codec, boolean sendCodecMeta, boolean sendFrameMeta) {
        this(fd, null, codec, sendCodecMeta, sendFrameMeta);
    }

    public Streamer(OutputStream out, Codec codec, boolean sendCodecMeta, boolean sendFrameMeta) {
        this(null, out, codec, sendCodecMeta, sendFrameMeta);
    }

    private Streamer(FileDescriptor fd, OutputStream out, Codec codec, boolean sendCodecMeta, boolean sendFrameMeta) {
        this.fd = fd;
        this.out = out;
        this.codec = codec;
    ...
    public void writeDisableStream(boolean error) throws IOException {
        ...
        if (fd != null) {
            ...
            IO.writeFully(out, code, 0, code.length);
        }
    }
